<template>
    ...
    <form v-on:submit.prevent="handleSubmit">
      ...
      <div class="mb-3 form-check">
        <div v-if="showterms" class="container" id="termscontainer">
          ...
          <p>
            2. You must enter your email address, name, password, confirm
            password
          </p>
        ...
        <label class="form-check-label" for="exampleCheck1"
          >I agree to the
          <span id="terms" @click="toggleterms" href="#"
  ...
  <div id="helpcontainer">
    <button
      ...
      id="help"
      @click="help()"
      onmouseover="this.innerHTML='Click Me'"
      onmouseout="this.innerHTML='Help'"
    >
      Help
    </button>
  </div>
...
export default {
  ...
  methods: {
    help: function () {
      alert(
        "Please enter your email address, name, password, confirm password, gender, company, and agree to the terms and conditions to sign up."
      );
    },
    confirm: function () {
